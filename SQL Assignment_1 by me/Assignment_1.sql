...
select round(avg(salary),3) as "Average Salary", count(*) as "No. of Employees" from hr.employees;
...
length(first_name)+length(last_name) as "Length of Name" from hr.employees;
...
select concat(first_name," ",last_name) as "Name", salary from hr.employees 
where salary not between 10000 and 15000;

/* 17 Write a query to display the name (first_name, last_name) 
and department ID of all employees in departments 30 or 100 in ascending order */

select concat(first_name," ",last_name) as "Name", department_id from hr.employees
...
select concat(first_name," ",last_name) as "Name", salary, department_id from hr.employees
...
select concat(first_name," ",last_name) as "Name", hire_date as "Hire Date" from hr.employees
where year(hire_date) = 1987;

/* 20 Write a query to display the first_name of all employees
...
/* 33 Write a query that displays the first name and the length of the first name for
all employees whose name starts with the letters 'A', 'J' or 'M'. Give each column an 
...
/* 34 Write a query to display the first name and salary for all employees. Format the salary to 
